        ...
        <div id="dress">
            <div id="women1">
                ...
                document.getElementById('button1').onclick=function()
                {
                    ...
                    var shirt="women printed kurtha ";
            ...
            <div id="women3">
                <img src="women3.jpg">
                <P> <b> Women's Straight Digital Print Kurta</b> </P>
                <p> &#x20b9; 1500 </p>
                <p> Material: Ploy Silk</p>
                <p>Size
                <select id="size3">
                    <option value="small">Small</option>
                    <option value="medium">Medium</option>
                ...
                document.getElementById('button3').onclick=function()
                {
                    ...
                    var x = s.options[s.selectedIndex].value;
                    var shirt="women straight digital print kurtha ";
                    var name=shirt.concat(x);
            ...
            <div id="women4">
                <img src="women4.jpg">
                <P> <b> Women's Gold Printed Sleeveless Kurta</b> </P>
                <p> &#x20b9; 500 </p>
                <p> Material: Rayon</p>
                <p>Size
                <select id="size4">
                ...
                document.getElementById('button4').onclick=function()
                {
                    ...
                    var x = s.options[s.selectedIndex].value;
                    var shirt="Women gold printed sleeveless kurta ";
                    var name=shirt.concat(x);
